//Funcionalidades con IF/ELSE IF/ELSE

//Funcionalidad signo del zodiaco
export let signoZodiacal = (fechaDeNacimiento:Date):string => {
...
export let paisContinente = (pais:string) => {
...
export let parOImpar = (parametro:number) => {
    if ((parametro % 2) === 0) {
